                    ...
                    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @if ($sse == 0)
                                <div class="p-2 bg-red-100 text-red-500 rounded text-sm text-center">
                                    The evaluators are not created yet.
                                </div>
                                @else
                                    @forelse ($assignInstructors->users as $ai)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10">
                                            {{-- <img class="h-10 w-10 rounded-full" src="{{ $ai->profile_photo_url }}" alt=""> --}}
                                            </div>
                                            <div class="ml-4">
                                    ...
                                    {{-- <tr>
                                        <td>
                                            <div>You dont have instructor to evaluate yet.</div>
                                        </td>
                                    </tr> --}}
                                    @endforelse
                                @endif
