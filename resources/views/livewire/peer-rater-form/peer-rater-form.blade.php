<div>
    <div class="mx-4 md:mx-36 my-16 space-y-4 font-Montserrat">
        ...
        <section class="space-y-2 text-gray-700 space-y-2">
            <h1 class="uppercase font-alfa tracking-widest text-xl text-center">Peer Rater Form (PRF)</h1>
            <div>
                <p class="text-sm">
                    <strong>Directions:</strong> This instrument aims to describe aspects of instructor's behavior in and out of the classroom.
                    ...
                    Your rating will be kept confidential
                </p>
            </div>
                ...
                @forelse ($questionairs as $questionair)
                    @if ($questionair->is_enabled === 1)
                        <form wire:submit.prevent="submit">
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center text-gray-700 font-medium p-2 rounded-md border-none bg-blue-100 space-x-2">
                                    ...
                                    <select wire:model="spe_id" class="mt-1 block w-52 py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        ...
                                        @endif
                                        @endforeach
                                        <x-jet-input-error for="spe_id" class="hidden md:block bg-red-100 p-1 rounded-md font-poppins border border-red-500" />
                                    </select>
                                    <x-jet-input-error for="spe_id" class="md:hidden bg-red-100 p-1 rounded-md font-poppins border border-red-500" />
                                </div>
                                <div class="hidden">
                        ...
                        <div class="flex justify-between">
                            ...
                            <div class="flex items-center px-4 py-3 bg-gray-50 text-right sm:px-6">
                                <x-jet-button class="ml-2" wire:click="$toggle('prfModal')" wire:loading.attr="disabled">
                                    {{ __('Submit') }}
                                </x-jet-button>
                            </div>
                        </div>
    ...
    <div>
        <section>
        <x-jet-dialog-modal wire:model.defer="prfModal">
            <x-slot name="title">
