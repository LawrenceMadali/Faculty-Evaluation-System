<div>
                    ...
                    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap"><div class="text-sm font-medium text-gray-900">{{ $course->course }}</div></td>
                                    ...
                                    <button wire:click="deleteOpenModal({{$course->id}})" class="text-red-600 hover:text-red-900">Delete</button>
                                    </td>
                                </tr>
                                @empty
                                <tr>
        ...
        <x-jet-dialog-modal wire:model.defer="editModal">
            ...
            <x-slot name="content">
                <form wire:submit.prevent="update">
                    <div class="col-span-6">
                        <label class="block text-sm font-medium text-gray-700">Course</label>
                        <input wire:model.lazy="course" type="text" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        <x-jet-input-error for="course"/>
                    </div>
                </form>
            </x-slot>
    ...
    <x-jet-dialog-modal wire:model.defer="deleteModal">
        ...
        <x-slot name="content">
            {{ __('Are you sure you want to delete selected course?') }}
        </x-slot>
