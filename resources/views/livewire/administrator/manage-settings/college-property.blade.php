                    ...
                    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"> College name </th>
            ...
            <x-slot name="content">
                <form wire:submit.prevent="create">
                    <div class="col-span-6">
                        ...
                        <input wire:model.lazy="name" type="text" placeholder="e.g. College of Computer Studies" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
