                                ...
                                <form action="#" method="POST">
                                    <div class="shadow overflow-hidden sm:rounded-md">
                                        ...
                                        <div class="flex justify-end items-center px-4 py-3 bg-gray-50 sm:px-6">
                                            <x-jet-action-message class="mr-3 p-2 rounded-lg bg-green-100 text-green-700" on="updated">
                                                {{ __('Updated.') }}
                                            </x-jet-action-message>
                                            <x-jet-button>
                                                {{ __('Update') }}
                            ...
                            <div class="mt-5 md:mt-0 md:col-span-2">
                                <form wire:submit.prevent="createEvaluationDetails">
                                    <div class="shadow overflow-hidden sm:rounded-md">
                                        ...
                                        <div class="flex justify-end items-center px-4 py-3 bg-gray-50 sm:px-6">
                                            <x-jet-action-message class="mr-3 p-2 rounded-lg bg-green-100 text-green-700" on="saved">
                                                {{ __('Saved.') }}
                                            </x-jet-action-message>
                                            <x-jet-button>
                                                {{ __('Save') }}
